...
public class FrontPage
{
    ...
    protected DapRequest daprequest = null;
     ...
     * @throws DapException
     */
    public FrontPage(String root, DapRequest daprequest)
            throws DapException
    {
            ...
            throws DapException
    {
        ...
        for(FileSource src : activesources) {
            ...
            for(File file : src.files) {
                ...
                String urlpath = this.daprequest.getServer() + "/" + this.daprequest.getServletPath() + datasetname; // append remainder not used by mappath
